            ...
            <table class="table mb-0" id="example" >
                ...
                <tbody>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <form action="/slider/{{ $da->id }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
                ...
                @csrf
                   <input type="hidden" name="data_id" id="data_id">
                      <div class="form-group">
                        <label for="foto" class="col-sm-2 control-label">Title</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control required" id="h1" name="h1"     required="">
                        </div>
                    </div>   
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control required" id="h2" name="h2"      required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control required" id="color" name="color"      required="">
                        </div>
                    </div>
                     <div class="form-group">
