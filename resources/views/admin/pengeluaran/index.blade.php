...
<div class="modal fade" id="date" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/cepengeluaran/cetak_pdf" method="post" target="_blank">
        {{ csrf_field() }}
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="/epengeluaran/import_excel" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   ...
                   <div class="form-group">
                        <label for="pk" class="col-sm-2 control-label">Pengeluaran_Kepada</label>
                        <div class="col-sm-12">
 ...
 $('#pesan-error,#pesan-sukses').hide()
  $(function () {
    ...
    $('body').on('click', '.editData', function () {
      ...
      $.get("{{ route('pengeluaran.index') }}" +'/' + data_id +'/edit', function (data) {

          $('#modelHeading').html("Edit Product");

          $('#saveBtn').val("edit-pengeluaran");
    ...
    $('body').on('click', '.deleteData', function () {
        ...
        $.ajax({
            ...
            url: "{{ route('pengeluaran.store') }}"+'/'+data_id,
