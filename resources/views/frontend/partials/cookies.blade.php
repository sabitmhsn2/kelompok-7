...
<div class="cookie-popup fixed max-w-lg bottom-3 right-3 left-3 sm:left-0 sm:right-0 mx-auto bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md py-5 px-6 z-50">
    <p class="text-slate-400">Situs web ini menggunakan cookie untuk memberi Anda pengalaman pengguna yang luar biasa. Dengan menggunakannya, Anda menerima <a href="https://shreethemes.in" target="_blank" class="text-emerald-600 dark:text-emerald-500 font-semibold">penggunaan cookie</a> kami</p>
